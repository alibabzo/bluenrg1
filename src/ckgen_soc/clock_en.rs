...
impl R {
    ...
    #[doc = "Bit 1 - Flash controller clock"]
    #[inline]
    ...
    #[doc = "Bit 2 - System controller clock"]
    #[inline]
    ...
    #[doc = "Bit 11 - MFT1 clock"]
    #[inline]
    pub fn mft1(&self) -> MFT1R {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 11;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[doc = "Bit 12 - MFT2 clock"]
    #[inline]
    pub fn mft2(&self) -> MFT2R {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 12;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
impl W {
    ...
    #[doc = "Bit 11 - MFT1 clock"]
    #[inline]
    pub fn mft1(&mut self) -> _MFT1W {
        _MFT1W { w: self }
    }
    #[doc = "Bit 12 - MFT2 clock"]
    #[inline]
    pub fn mft2(&mut self) -> _MFT2W {
        _MFT2W { w: self }
    }
    #[doc = "Bit 13 - RTC clock"]
    #[inline]
